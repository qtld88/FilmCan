...
2. Duplicate detection split between RsyncService and CustomCopierService
3. CustomCopierService complexity (single responsibility concerns)
...
7. `MultiDestSummaryView` is deprecated (dead code) — should be removed once fan-out path is fully validated in prod
